package com.peihua.alarmdemo.utils;
...
public class Logcat {
     ...
     * @param log
     */
    public static void writeLog(Context context, String tagStr, String log) {
     ...
     * @param log
     */
    public static void writeLog(Context context, int stackTraceIndex, String tagStr, String log) {
        ...
        AsyncTask.execute(() -> FileLog.writeLog(context, tag + " " + logMsg));
    }
    ...
    static class FileLog {
        ...
        static void writeLog(Context context, String logString) {
            try {
                File rootFile = Environment.getExternalStorageDirectory();
                File parentFile = context.getExternalCacheDir();
